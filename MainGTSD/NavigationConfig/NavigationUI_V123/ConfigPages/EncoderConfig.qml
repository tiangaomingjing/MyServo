...
Item {
    ...
    Timer{
        ...
        onTriggered: {
            posIn=parseInt(mg_servoCmd.readCommand("gSevDrv.sev_obj.cur.rsv.pos_in"));
            pos=parseInt(mg_servoCmd.readCommand("gSevDrv.sev_obj.cur.rsv.pos"));
            posOffset=parseInt(mg_servoCmd.readCommand("gSevDrv.sev_obj.cur.rsv.prm.pos_ofst"));
            ...
            if(searchPhaseIsClicked){
                var flagServo=false;
                var ret=0;
                ret=parseInt(mg_servoCmd.readCommand("gSevDrv.sev_obj.mfj.pos_adj_flag"))
                ...
                if(flagServo){
                    ...
                    checkCount=0;
                    mg_servoCmd.setServoOn(false);
                    var retV=mg_servoCmd.writeAdvanceFlash("gSevDrv.sev_obj.cur.rsv.prm.pos_ofst",posOffset);
        ...
        Rectangle{
            ...
            MouseArea{
                ...
                onClicked: {
                    ...
                    mg_servoCmd.writeFunctionValue2Flash(encoderXmlPath,"gSevDrv.sev_obj.cur.rsv.prm.line_num_3",value);
                    //设置编码盘类型
                    value=m_encoderComboBox.currentIndex+1;
                    mg_servoCmd.writeFunctionValue2Flash(encoderXmlPath,"gSevDrv.sev_obj.cur.rsv.prm.coder_typ_3",value);
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onClicked: {
                ...
                var srcSelect=100;
                srcSelect=parseInt(mg_servoCmd.readCommand("gSevDrv.sev_obj.pos.seq.prm.cmd_src_sel"));
