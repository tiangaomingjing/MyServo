...
Rectangle {
    ...
    Text{
        ...
        MouseArea{
            anchors.fill: parent;
            onClicked: {
                console.log("count "+typeDataModel.count)
                for(var i=0;i<typeDataModel.count;i++){
//                    console.log("type "+typeDataModel.get(i).type);
//                    console.log("axisCount "+typeDataModel.get(i).axisCount);
                    keyValue[typeDataModel.get(i).type]=typeDataModel.get(i).axisCount;
                }
                console.log("keyValue "+keyValue["GTSD_4X"]);
                console.log("keyValue "+keyValue["GTSD_6X"]);
                console.log("keyValue "+keyValue["aaa"]);
            }
        }
    }
    RowLayout{
    ...
    XmlListModel{
        ...
        Component.onCompleted: {
            if(typeDataModel.status===XmlListModel.Ready){
