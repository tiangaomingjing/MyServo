...
//        penColor: "red"
    ...
    LineEditBlock{
        ...
        anchors.verticalCenterOffset: background.hPercent*currentLimit.height/2;
//        onValueChanged: {
//            currentLimit.absValueChanged(value);
//        }
    }
    LineEditBlock{
        id:pos_rat;
...
//        onValueChanged: {
//            currentLimit.posValueChanged(value);
//        }
    }
    LineEditBlock{
        id:neg_rat;
...
//        onValueChanged: {
//            currentLimit.negValueChanged(value);
//        }
    }
    SegmentArrow{
        id:arrow1;
