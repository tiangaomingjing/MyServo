...
//        mg_servoCmd.writeCommand("gSevDrv.sev_obj.vel.ctl.prm.neg_rat_5",negT);
    ...
    Component.onCompleted: {
        m_posLimitBlock.editText1=50;
        m_posLimitBlock.editText2=50;
        m_posLimitBlock.editText3=50;
        m_speedLimitBlock.absEditText=50;
        m_speedLimitBlock.negEditText=50;
        m_speedLimitBlock.posEditText=50;
    }
